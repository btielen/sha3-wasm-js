...
*/
void SHAKE128(const unsigned char *input, unsigned int inputByteLen, unsigned char *output, int outputByteLen)
{
...
*/
void SHAKE256(const unsigned char *input, unsigned int inputByteLen, unsigned char *output, int outputByteLen)
{
...
*/
void SHA3_224(const unsigned char *input, unsigned int inputByteLen, unsigned char *output)
{
...
*/
void SHA3_384(const unsigned char *input, unsigned int inputByteLen, unsigned char *output)
{
...
*/
void SHA3_512(const unsigned char *input, unsigned int inputByteLen, unsigned char *output)
{
