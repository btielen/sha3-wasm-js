var Init_EmscriptenModule = function(Init_EmscriptenModule) {
    Init_EmscriptenModule = Init_EmscriptenModule || {};
...
// can continue to use Module afterwards as well.
    var Module = typeof Init_EmscriptenModule !== 'undefined' ? Init_EmscriptenModule : {};
...
// Indicates whether filename is a base64 data URI.
    ...
    function integrateWasmJS() {
        ...
        var wasmTextFile = 'src/sha3.wast';
        var wasmBinaryFile = 'src/sha3.wasm';
        var asmjsCodeFile = 'src/sha3.temp.asm.js';
...
// {{MODULE_ADDITIONS}}
    ...
    return Init_EmscriptenModule;
};
if (typeof exports === 'object' && typeof module === 'object')
    module.exports = Init_EmscriptenModule;
else if (typeof define === 'function' && define['amd'])
    define([], function() { return Init_EmscriptenModule; });
else if (typeof exports === 'object')
    exports["Init_EmscriptenModule"] = Init_EmscriptenModule;